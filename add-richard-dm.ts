...
async function main() {
  await addDM("Richard Whittaker Ltd", "Alan Rigby", "Managing Director", "info@richard-whittaker.com");
  await addDM("Richard Whittaker Ltd", "Thom Rigby", "Production Director", "info@richard-whittaker.com");
}
