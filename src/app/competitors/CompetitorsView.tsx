      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-[280px] border-r border-[#2D3142]/10 flex flex-col bg-[#F4F1EA] shrink-0">
          ...
          <div className="p-3 border-t border-[#2D3142]/10 bg-[#F4F1EA]">
            <button onClick={() => setShowMoreFiltersModal(true)} className="w-full flex items-center justify-center gap-2 py-2 bg-[#F16775] hover:bg-[#E05663] text-white rounded font-medium transition-colors shadow-sm">
