...
async function main() {
  await addDM("Steenbergs Organic", "Axel Steenberg", "Founder & Sourcing", "axel@steenbergs.co.uk");
  await addDM("Steenbergs Organic", "Sophie Steenberg", "Founder", "axel@steenbergs.co.uk");
}
