export const competitorData: Record<string, any> = {
  ...
  amyra: {
    ...
    coreNarrative:
      "Lakadong turmeric from the Jaintia hills — one of the world's highest curcumin varietals at 7-12%. Deep orange, peppery, real.",
    pricing: {
      premiumPositioning: "Premium",
    ...
    strategy: {
      ...
      content:
        "Amyra Farms emphasizes high curcumin and quick delivery through platforms like Blinkit and Amazon. AmrootOS can position higher in luxury appeal, detailed clinical transparency, and superior packaging.",
    },
    portfolio: [
      {
  ...
  asavi: {
    idKeys: ["brand-asavi"],
    name: "ASAVI",
    company: "ASAVI (Verification Pending)",
    entityType: "FMCG / Retail",
    location: "Unknown",
    marketTier: "mass-premium",
    curcuminValue: 0,
  ...
  "aamrai-organic": {
    ...
    name: "Aamrai Organic",
    company: "Aamrai Organic (Verification Pending)",
    entityType: "FMCG / Retail",
    location: "Unknown",
    marketTier: "mass-premium",
    curcuminValue: 0,
  ...
  "24-mantra-organic": {
    ...
    founderSocialUrl: "Unknown",
    foundingYear: "Unknown",
    headquarters: "Sresta Natural Bioproducts Pvt, Ltd,. Plot no. 11, Krithika Madhapur layout, TS.64, Madhapur, Hyderabad, Telangana, 500081.",
    country: "Unknown",
    manufacturingLocations: "Unknown",
    processingLocations: "Unknown",
    exportMarkets: "Unknown",
