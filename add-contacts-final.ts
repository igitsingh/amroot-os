...
async function main() {
  await addDM("Abbott Blackstone International", "Emilie", "Purchasing Manager", "info@abbottblackstone.eu");
  await addDM("UK Blending Ltd", "Mark Bartlett", "Founder & Director", "sales@ukblending.com");
  await addDM("UK Blending Ltd", "Tracy Bartlett", "Founder", "sales@ukblending.com");
}
